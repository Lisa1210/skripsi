...
?>
	...
	<form method="POST" action="">
        ...
        <div class="form-group">
            ...
            <input type="text" id="nama" name="agama" class="form-control" value="<?php echo $h['agama']; ?>" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" id="nama" name="status" class="form-control" value="<?php echo $h['status']; ?>" />
        </div>
        <div class="form-group">
