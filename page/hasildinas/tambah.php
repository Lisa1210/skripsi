...
if(isset($_POST['tambah'])){
	...
	$q=mysqli_query($koneksi,"insert into hasil_dinas values (null, '$nama','$hasil_dinas','$setor','$no_ssbp','$tanggal_setor','$amar_putusan')");
	...
	?><script>location.href='?page=hasil_dinas';</script><?php
}
?>
